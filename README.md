...
• **AI-based Sign Language Recognition using Attention-Enhanced LSTM**  
  InCACCT 2025 — Improved sequence learning for gesture recognition  

• **RAG Framework with LLMs for Public Health Response**  
  InCACCT 2025 (IEEE) — Enhanced information retrieval & decision support  

• **SignSpeakNet: Spatio-Temporal Sign Language Recognition (BiLSTM + Attention)**  
  ICCCNT 2025 — Improved accuracy using attention-based deep learning  
